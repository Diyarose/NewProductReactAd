  ...
  return (
    <div>
        ...
        <div className="container">
            <h1><center><i>PRODUCT DETAILS</i></center></h1>
            <br></br>
            <div className="row">
                <div className="col-col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div className="row g-3">
                        ...
                        <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <label htmlFor="" className="form-label">MFD</label>
                            <input type="text" className="form-control" name='MFD' value={data.MFD} onChange={inputHandler} />
                        </div>
                        <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
